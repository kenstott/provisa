...
Each requirement is anchored — link to one directly with `#REQ-NNN` (e.g. [REQ-001](#REQ-001)). Inline `REQ-NNN` mentions deep-link to their section, and the docs search box indexes every requirement by id, category, and description.

## 1. Access Governance & Security

### REQ-001 · Query Governance {#REQ-001}
...
### REQ-004 · Query Governance {#REQ-004}
...
### REQ-005 · Query Governance {#REQ-005}
...
### REQ-006 · Query Governance {#REQ-006}

**Status:** ✅ complete · **Priority:** MAY · **Type:** behavioral

Large-result redirect and Arrow output are available to any query the user's rights permit, subject to configured thresholds ([REQ-029](#REQ-029), [REQ-137](#REQ-137)).
...
### REQ-203 · ABAC Approval Hook {#REQ-203}
...
### REQ-204 · ABAC Approval Hook {#REQ-204}
...
### REQ-246 · ABAC Approval Hook {#REQ-246}
...
### REQ-247 · ABAC Approval Hook {#REQ-247}
...
### REQ-262 · Two-Stage Compiler (Governed SQL) {#REQ-262}
...
### REQ-263 · Two-Stage Compiler (Governed SQL) {#REQ-263}

**Status:** ✅ complete · **Priority:** MUST · **Type:** behavioral

Stage 2 governance transformer applies four governance concerns: (1) RLS — inject WHERE predicate per table reference per role (SQLGlot AST rewrite); (2) column masking — wrap masked column expressions with masking function (AST rewrite); (3) column visibility — remove or NULL-out columns invisible to the role (AST rewrite); (4) row cap — inject/cap LIMIT to the most restrictive per-role/table `max_rows` ceiling for any referenced table. A role without the FULL_RESULTS capability receives the configured default cap. The row cap is the single mechanism for bounding result size; statistical sampling is a user query feature, not a governance concern ([REQ-478](#REQ-478)).
...
### REQ-264 · Two-Stage Compiler (Governed SQL) {#REQ-264}
...
### REQ-265 · Two-Stage Compiler (Governed SQL) {#REQ-265}
...
### REQ-266 · Two-Stage Compiler (Governed SQL) {#REQ-266}
...
### REQ-267 · Two-Stage Compiler (Governed SQL) {#REQ-267}
...
### REQ-371 · Rate Limiting {#REQ-371}

**Status:** ✅ complete · **Priority:** MUST · **Type:** infrastructure

Rate limit state stored in Redis (existing `cache.redis_url`) using a sliding window counter. No rate limit state is held in-process — stateless Provisa containers ([REQ-057](#REQ-057)) share limit state across all instances.
...
### REQ-555 · ABAC Approval Hook {#REQ-555}
...
### REQ-556 · ABAC Approval Hook {#REQ-556}
...
### REQ-120 · Authentication {#REQ-120}
...
### REQ-121 · Authentication {#REQ-121}
...
### REQ-122 · Authentication {#REQ-122}
...
### REQ-123 · Authentication {#REQ-123}
...
### REQ-124 · Authentication {#REQ-124}
...
### REQ-551 · Authentication {#REQ-551}
...
### REQ-012 · Registration & Governance {#REQ-012}
...
### REQ-013 · Registration & Governance {#REQ-013}
...
### REQ-014 · Registration & Governance {#REQ-014}
...
### REQ-015 · Registration & Governance {#REQ-015}
...
### REQ-016 · Registration & Governance {#REQ-016}
...
### REQ-017 · Registration & Governance {#REQ-017}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

NoSQL/non-relational sources are exposed read-only through their native Trino connector (e.g. the MongoDB connector), driven by the type-specific mapping DSL ([REQ-251](#REQ-251)); no mutations. (Revised 2026-06-18: the original "automatic Parquet materialization" wording is superseded by the connector approach, which is the implementation.)
...
### REQ-018 · Registration & Governance {#REQ-018}
...
### REQ-019 · Registration & Governance {#REQ-019}
...
### REQ-119 · JSONB & API Sources {#REQ-119}
...
### REQ-133 · Views (Governed Computed Datasets) {#REQ-133}
...
### REQ-134 · Views (Governed Computed Datasets) {#REQ-134}
...
### REQ-135 · Views (Governed Computed Datasets) {#REQ-135}
...
### REQ-136 · Views (Governed Computed Datasets) {#REQ-136}
...
### REQ-151 · Column Path Extraction {#REQ-151}
...
### REQ-152 · Column Path Extraction {#REQ-152}
...
### REQ-153 · Column Path Extraction {#REQ-153}
...
### REQ-158 · Auto-Materialized Relationships {#REQ-158}
...
### REQ-159 · Auto-Materialized Relationships {#REQ-159}
...
### REQ-160 · Auto-Materialized Relationships {#REQ-160}
...
### REQ-194 · Naming Convention {#REQ-194}
...
### REQ-195 · Naming Convention {#REQ-195}
...
### REQ-250 · Registration & Governance {#REQ-250}
...
### REQ-251 · Registration & Governance {#REQ-251}
...
### REQ-363 · Semantic Layer / Semantic Model {#REQ-363}
...
### REQ-413 · Registration & Governance {#REQ-413}
...
### REQ-414 · Registration & Governance {#REQ-414}
...
### REQ-415 · Registration & Governance {#REQ-415}
...
### REQ-417 · Registration & Governance {#REQ-417}
...
### REQ-432 · Registration & Governance {#REQ-432}
...
### REQ-433 · Registration & Governance {#REQ-433}
...
### REQ-543 · Auto-Materialized Relationships {#REQ-543}
...
### REQ-605 · Registration & Governance {#REQ-605}
...
### REQ-611 · Registration & Governance {#REQ-611}
...
### REQ-612 · Registration & Governance {#REQ-612}
...
### REQ-635 · Registration & Governance {#REQ-635}
...
### REQ-636 · Registration & Governance {#REQ-636}
...
### REQ-637 · Registration & Governance {#REQ-637}
...
### REQ-638 · Registration & Governance {#REQ-638}
...
### REQ-639 · Registration & Governance {#REQ-639}
...
### REQ-641 · Registration & Governance {#REQ-641}
...
### REQ-229 · Direct-Route Dialect Expansion {#REQ-229}
...
### REQ-295 · Query-API Sources (Neo4j & SPARQL) {#REQ-295}
...
### REQ-296 · Query-API Sources (Neo4j & SPARQL) {#REQ-296}
...
### REQ-297 · Query-API Sources (Neo4j & SPARQL) {#REQ-297}
...
### REQ-298 · Query-API Sources (Neo4j & SPARQL) {#REQ-298}
...
### REQ-299 · Query-API Sources (Neo4j & SPARQL) {#REQ-299}
...
### REQ-307 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-307}
...
### REQ-308 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-308}
...
### REQ-311 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-311}
...
### REQ-312 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-312}
...
### REQ-313 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-313}
...
### REQ-314 · OpenAPI Auto-Registration Connector {#REQ-314}
...
### REQ-315 · OpenAPI Auto-Registration Connector {#REQ-315}
...
### REQ-316 · OpenAPI Auto-Registration Connector {#REQ-316}
...
### REQ-317 · OpenAPI Auto-Registration Connector {#REQ-317}
...
### REQ-318 · OpenAPI Auto-Registration Connector {#REQ-318}
...
### REQ-319 · OpenAPI Auto-Registration Connector {#REQ-319}
...
### REQ-320 · OpenAPI Auto-Registration Connector {#REQ-320}
...
### REQ-321 · OpenAPI Auto-Registration Connector {#REQ-321}
...
### REQ-322 · gRPC Remote Schema Connector (REQ-322–329) {#REQ-322}
...
### REQ-323 · gRPC Remote Schema Connector (REQ-322–329) {#REQ-323}
...
### REQ-324 · gRPC Remote Schema Connector (REQ-322–329) {#REQ-324}
...
### REQ-325 · gRPC Remote Schema Connector (REQ-322–329) {#REQ-325}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

Each query-classified gRPC method is exposed as a virtual read-only table. Output message fields become columns using the type mapping in [REQ-324](#REQ-324). Input message fields become GraphQL query arguments. Server-streaming methods (`Stream*`) collect all streamed response messages into a list before returning rows.
...
### REQ-326 · gRPC Remote Schema Connector (REQ-322–329) {#REQ-326}
...
### REQ-327 · gRPC Remote Schema Connector (REQ-322–329) {#REQ-327}
...
### REQ-329 · gRPC Remote Schema Connector (REQ-322–329) {#REQ-329}
...
### REQ-331 · Ingest Sources — Governed HTTP Push Receiver (REQ-331–337) {#REQ-331}
...
### REQ-332 · Ingest Sources — Governed HTTP Push Receiver (REQ-331–337) {#REQ-332}
...
### REQ-333 · Ingest Sources — Governed HTTP Push Receiver (REQ-331–337) {#REQ-333}
...
### REQ-334 · Ingest Sources — Governed HTTP Push Receiver (REQ-331–337) {#REQ-334}
...
### REQ-335 · Ingest Sources — Governed HTTP Push Receiver (REQ-331–337) {#REQ-335}
...
### REQ-336 · Ingest Sources — Governed HTTP Push Receiver (REQ-331–337) {#REQ-336}
...
### REQ-337 · Ingest Sources — Governed HTTP Push Receiver (REQ-331–337) {#REQ-337}
...
### REQ-338 · Phase AT — WebSocket & RSS Sources (REQ-338–344) {#REQ-338}
...
### REQ-339 · Phase AT — WebSocket & RSS Sources (REQ-338–344) {#REQ-339}
...
### REQ-340 · Phase AT — WebSocket & RSS Sources (REQ-338–344) {#REQ-340}
...
### REQ-341 · Phase AT — WebSocket & RSS Sources (REQ-338–344) {#REQ-341}
...
### REQ-342 · Phase AT — WebSocket & RSS Sources (REQ-338–344) {#REQ-342}
...
### REQ-343 · Phase AT — WebSocket & RSS Sources (REQ-338–344) {#REQ-343}
...
### REQ-344 · Phase AT — WebSocket & RSS Sources (REQ-338–344) {#REQ-344}
...
### REQ-372 · File & Lake Sources {#REQ-372}
...
### REQ-541 · GovData Sources {#REQ-541}
...
### REQ-550 · Registration & Governance {#REQ-550}
...
### REQ-553 · Registration & Governance {#REQ-553}
...
### REQ-597 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-597}
...
### REQ-598 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-598}
...
### REQ-599 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-599}
...
### REQ-600 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-600}
...
### REQ-601 · OpenAPI Auto-Registration Connector {#REQ-601}
...
### REQ-602 · GraphQL Remote Schema Connector (REQ-307–313) {#REQ-602}
...
### REQ-007 · Compiler & Schema {#REQ-007}
...
### REQ-008 · Compiler & Schema {#REQ-008}
...
### REQ-009 · Compiler & Schema {#REQ-009}

**Status:** ✅ complete · **Priority:** MUST · **Type:** behavioral

Query compilation produces PG-style SQL from validated GraphQL AST — single SQL statement, no resolver chain, no N+1. Exception: action query fields ([REQ-361](#REQ-361)) and remote-schema relationships ([REQ-313](#REQ-313)) resolve nested relationships via batched secondary fetches, which is outside this single-statement guarantee.
...
### REQ-010 · Compiler & Schema {#REQ-010}
...
### REQ-011 · Compiler & Schema {#REQ-011}
...
### REQ-032 · Mutation Execution {#REQ-032}

**Status:** ✅ complete · **Priority:** MUST · **Type:** behavioral

DB mutations are single-source by definition, bypass Trino, no routing decision, no registry approval — but always require write authority on the target table ([REQ-033](#REQ-033)). Webhook mutations are governed separately and require specific steward approval for use ([REQ-209](#REQ-209)).
...
### REQ-033 · Mutation Execution {#REQ-033}
...
### REQ-034 · Mutation Execution {#REQ-034}
...
### REQ-035 · Mutation Execution {#REQ-035}
...
### REQ-036 · Mutation Execution {#REQ-036}
...
### REQ-037 · Mutation Execution {#REQ-037}
...
### REQ-066 · SQLGlot Transpilation {#REQ-066}
...
### REQ-067 · SQLGlot Transpilation {#REQ-067}
...
### REQ-068 · SQLGlot Transpilation {#REQ-068}
...
### REQ-200 · OrderBy Alignment {#REQ-200}
...
### REQ-201 · OrderBy Alignment {#REQ-201}
...
### REQ-202 · OrderBy Alignment {#REQ-202}
...
### REQ-205 · Tracked Functions & Custom Mutations {#REQ-205}
...
### REQ-206 · Tracked Functions & Custom Mutations {#REQ-206}
...
### REQ-207 · Tracked Functions & Custom Mutations {#REQ-207}
...
### REQ-208 · Tracked Functions & Custom Mutations {#REQ-208}
...
### REQ-209 · Tracked Functions & Custom Mutations {#REQ-209}

**Status:** ✅ complete · **Priority:** MUST · **Type:** behavioral

Webhook-backed mutations — external HTTP endpoint called as a GraphQL mutation (Part of Phase AC). Config includes name, url, method, domain_id, governance (requires_approval), arguments with name and type, returns (registered table or inline type), visible_to, and timeout_ms. Webhook mutations are NOT DB mutations ([REQ-031](#REQ-031)/[REQ-032](#REQ-032)) and require specific steward approval for use; `governance: registry-required` gates them.
...
### REQ-210 · Tracked Functions & Custom Mutations {#REQ-210}
...
### REQ-211 · Tracked Functions & Custom Mutations {#REQ-211}
...
### REQ-252 · Compiler & Schema {#REQ-252}
...
### REQ-253 · Compiler & Schema {#REQ-253}
...
### REQ-259 · Compiler & Schema {#REQ-259}
...
### REQ-300 · GraphQL Variable Defaults {#REQ-300}
...
### REQ-301 · GraphQL Variable Defaults {#REQ-301}
...
### REQ-304 · Tracked DB Functions — Custom Return Schema (REQ-304–306) {#REQ-304}
...
### REQ-305 · Tracked DB Functions — Custom Return Schema (REQ-304–306) {#REQ-305}
...
### REQ-306 · Tracked DB Functions — Custom Return Schema (REQ-304–306) {#REQ-306}
...
### REQ-345 · Cypher Query Frontend (Phase AU) {#REQ-345}
...
### REQ-348 · Cypher Query Frontend (Phase AU) {#REQ-348}
...
### REQ-349 · Cypher Query Frontend (Phase AU) {#REQ-349}
...
### REQ-351 · Cypher Query Frontend (Phase AU) {#REQ-351}
...
### REQ-352 · Cypher Query Frontend (Phase AU) {#REQ-352}
...
### REQ-353 · Cypher Query Frontend (Phase AU) {#REQ-353}
...
### REQ-354 · Natural Language Query Service (Phase AV) {#REQ-354}
...
### REQ-355 · Natural Language Query Service (Phase AV) {#REQ-355}
...
### REQ-356 · Natural Language Query Service (Phase AV) {#REQ-356}
...
### REQ-357 · Natural Language Query Service (Phase AV) {#REQ-357}
...
### REQ-358 · Natural Language Query Service (Phase AV) {#REQ-358}
...
### REQ-359 · Natural Language Query Service (Phase AV) {#REQ-359}
...
### REQ-360 · Tracked Functions & Custom Mutations {#REQ-360}
...
### REQ-361 · Tracked Functions & Custom Mutations {#REQ-361}
...
### REQ-362 · Tracked Functions & Custom Mutations {#REQ-362}
...
### REQ-403 · Compiler & Schema {#REQ-403}
...
### REQ-409 · Compiler & Schema {#REQ-409}
...
### REQ-411 · Compiler & Schema {#REQ-411}
...
### REQ-412 · Compiler & Schema {#REQ-412}
...
### REQ-416 · Compiler & Schema {#REQ-416}
...
### REQ-478 · Compiler & Schema {#REQ-478}

**Status:** ✅ complete · **Priority:** MAY · **Type:** behavioral

Statistical row sampling is a user query feature, not governance. Root query fields accept an optional `sample: Float` argument (percentage in (0, 100]); the compiler emits `TABLESAMPLE BERNOULLI (<pct>)` on the base table, which SQLGlot transpiles per dialect (direct PG and Trino both supported). Out-of-range values are rejected at compile time. Not combinable with `as_of` (time-travel) or op-relationship lateral joins. Raw-SQL clients use native `TABLESAMPLE` directly. Distinct from the [REQ-263](#REQ-263) row cap, which bounds result size.
...
### REQ-525 · Compiler & Schema {#REQ-525}
...
### REQ-526 · Compiler & Schema {#REQ-526}
...
### REQ-534 · Compiler & Schema {#REQ-534}
...
### REQ-537 · Compiler & Schema {#REQ-537}
...
### REQ-571 · Cypher Query Frontend (Phase AU) {#REQ-571}
...
### REQ-572 · Cypher Query Frontend (Phase AU) {#REQ-572}
...
### REQ-573 · Cypher Query Frontend (Phase AU) {#REQ-573}
...
### REQ-574 · Cypher Query Frontend (Phase AU) {#REQ-574}
...
### REQ-575 · Cypher Query Frontend (Phase AU) {#REQ-575}
...
### REQ-576 · Cypher Query Frontend (Phase AU) {#REQ-576}
...
### REQ-577 · Cypher Query Frontend (Phase AU) {#REQ-577}
...
### REQ-578 · Cypher Query Frontend (Phase AU) {#REQ-578}
...
### REQ-654 · Compiler & Schema {#REQ-654}
...
### REQ-655 · Compiler & Schema {#REQ-655}
...
### REQ-661 · Cypher Mutations {#REQ-661}
...
### REQ-663 · Cypher Mutations {#REQ-663}
...
### REQ-664 · Cypher Mutations {#REQ-664}
...
### REQ-665 · Cypher Mutations {#REQ-665}
...
### REQ-666 · Cypher Mutations {#REQ-666}
...
### REQ-667 · Cypher Mutations {#REQ-667}
...
### REQ-668 · Cypher Mutations {#REQ-668}
...
### REQ-669 · Cypher Mutations {#REQ-669}
...
### REQ-670 · Cypher Mutations {#REQ-670}
...
### REQ-671 · Cypher Mutations {#REQ-671}
...
### REQ-027 · Execution & Routing {#REQ-027}
...
### REQ-028 · Execution & Routing {#REQ-028}
...
### REQ-029 · Execution & Routing {#REQ-029}
...
### REQ-030 · Execution & Routing {#REQ-030}
...
### REQ-031 · Execution & Routing {#REQ-031}
...
### REQ-053 · Data & Storage {#REQ-053}

**Status:** ✅ complete · **Priority:** MAY · **Type:** structural

PgBouncer is the documented per-PostgreSQL-source opt-in via `use_pgbouncer` (default off); it is NOT forced on, because a default-on would require a running PgBouncer for every PG source. Default is direct asyncpg pooling ([REQ-052](#REQ-052)).
...
### REQ-230 · Hot Tables (Redis-Cached Lookups) {#REQ-230}
...
### REQ-231 · Hot Tables (Redis-Cached Lookups) {#REQ-231}
...
### REQ-232 · Hot Tables (Redis-Cached Lookups) {#REQ-232}
...
### REQ-233 · Hot Tables (Redis-Cached Lookups) {#REQ-233}
...
### REQ-234 · Materialized View Lifecycle {#REQ-234}
...
### REQ-235 · Materialized View Lifecycle {#REQ-235}
...
### REQ-236 · Hot Table Auto-Detection {#REQ-236}
...
### REQ-237 · Hot Table Auto-Detection {#REQ-237}
...
### REQ-239 · Warm Tables (Replica Profile — Low-Latency Placement) {#REQ-239}
...
### REQ-240 · Warm Tables (Replica Profile — Low-Latency Placement) {#REQ-240}
...
### REQ-241 · Warm Tables (Replica Profile — Low-Latency Placement) {#REQ-241}
...
### REQ-275 · Federation Performance {#REQ-275}
...
### REQ-276 · Federation Performance {#REQ-276}
...
### REQ-277 · Federation Performance {#REQ-277}
...
### REQ-278 · Federation Performance {#REQ-278}
...
### REQ-279 · Federation Performance {#REQ-279}
...
### REQ-280 · Federation Performance {#REQ-280}

**Status:** ✅ complete · **Priority:** MUST · **Type:** behavioral

ANALYZE runs on the API cache table after each materialization CTAS; ANALYZE failure is logged, not raised (connector tolerance, matching `analyze_source_tables` / [REQ-275](#REQ-275)).
...
### REQ-281 · Federation Performance {#REQ-281}
...
### REQ-397 · Execution & Routing {#REQ-397}
...
### REQ-536 · Execution & Routing {#REQ-536}
...
### REQ-552 · Execution & Routing {#REQ-552}
...
### REQ-047 · Output & Delivery {#REQ-047}
...
### REQ-048 · Output & Delivery {#REQ-048}
...
### REQ-049 · Output & Delivery {#REQ-049}
...
### REQ-050 · Output & Delivery {#REQ-050}
...
### REQ-137 · Large Result Redirect & CTAS {#REQ-137}
...
### REQ-138 · Large Result Redirect & CTAS {#REQ-138}
...
### REQ-139 · Large Result Redirect & CTAS {#REQ-139}
...
### REQ-140 · Large Result Redirect & CTAS {#REQ-140}
...
### REQ-141 · Large Result Redirect & CTAS {#REQ-141}
...
### REQ-142 · Large Result Redirect & CTAS {#REQ-142}
...
### REQ-043 · API & Integration {#REQ-043}
...
### REQ-045 · API & Integration {#REQ-045}
...
### REQ-126 · JDBC/ODBC Integration {#REQ-126}
...
### REQ-127 · JDBC/ODBC Integration {#REQ-127}
...
### REQ-128 · JDBC/ODBC Integration {#REQ-128}
...
### REQ-129 · JDBC/ODBC Integration {#REQ-129}
...
### REQ-131 · JDBC/ODBC Integration {#REQ-131}
...
### REQ-161 · Query Development Tools {#REQ-161}
...
### REQ-163 · Query Development Tools {#REQ-163}
...
### REQ-256 · API & Integration {#REQ-256}
...
### REQ-257 · API & Integration {#REQ-257}
...
### REQ-258 · API & Integration {#REQ-258}
...
### REQ-268 · SQL & Multi-Protocol Client Access {#REQ-268}
...
### REQ-269 · SQL & Multi-Protocol Client Access {#REQ-269}
...
### REQ-270 · SQL & Multi-Protocol Client Access {#REQ-270}
...
### REQ-271 · SQL & Multi-Protocol Client Access {#REQ-271}
...
### REQ-272 · SQL & Multi-Protocol Client Access {#REQ-272}
...
### REQ-273 · SQL & Multi-Protocol Client Access {#REQ-273}
...
### REQ-288 · Automatic Persisted Queries (APQ) {#REQ-288}
...
### REQ-289 · Automatic Persisted Queries (APQ) {#REQ-289}
...
### REQ-290 · Automatic Persisted Queries (APQ) {#REQ-290}
...
### REQ-291 · Automatic Persisted Queries (APQ) {#REQ-291}
...
### REQ-293 · JDBC/ODBC Integration {#REQ-293}
...
### REQ-405 · API & Integration {#REQ-405}
...
### REQ-406 · API & Integration {#REQ-406}
...
### REQ-407 · API & Integration {#REQ-407}
...
### REQ-408 · API & Integration {#REQ-408}
...
### REQ-538 · JDBC/ODBC Integration {#REQ-538}
...
### REQ-607 · SQL & Multi-Protocol Client Access {#REQ-607}
...
### REQ-172 · Dataset Change Events {#REQ-172}
...
### REQ-173 · Dataset Change Events {#REQ-173}
...
### REQ-174 · Dataset Change Events {#REQ-174}
...
### REQ-175 · Dataset Change Events {#REQ-175}
...
### REQ-176 · Kafka Sinks (Table/View Publishing) {#REQ-176}
...
### REQ-177 · Kafka Sinks (Table/View Publishing) {#REQ-177}
...
### REQ-178 · Kafka Sinks (Table/View Publishing) {#REQ-178}
...
### REQ-180 · Kafka Sinks (Table/View Publishing) {#REQ-180}
...
### REQ-181 · Kafka Sinks (Table/View Publishing) {#REQ-181}
...
### REQ-282 · Live Query Engine (Unified Subscription & Sink Delivery) {#REQ-282}
...
### REQ-286 · Live Query Engine (Unified Subscription & Sink Delivery) {#REQ-286}
...
### REQ-287 · Live Query Engine (Unified Subscription & Sink Delivery) {#REQ-287}
...
### REQ-060 · UI & Frontend {#REQ-060}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** ui

Capabilities: Source Registration, Table Registration, Relationship Registration, Security Configuration, Query Development, Admin. Holders of a create capability (e.g. Relationship/View Registration) also execute creation requests queued by users lacking that capability ([REQ-063](#REQ-063)).
...
### REQ-248 · UI & Design Patterns {#REQ-248}
...
### REQ-249 · UI & Design Patterns {#REQ-249}
...
### REQ-644 · Graph Grouping — View Transform {#REQ-644}
...
### REQ-645 · Graph Grouping — Attribute Discovery {#REQ-645}
...
### REQ-646 · Graph Grouping — Color Encoding {#REQ-646}
...
### REQ-647 · Graph Grouping — Hull SVG Overlay {#REQ-647}
...
### REQ-648 · Graph Grouping — Collapse to Supernode {#REQ-648}
...
### REQ-649 · Graph Node Size Encoding {#REQ-649}
...
### REQ-055 · Infrastructure {#REQ-055}
...
### REQ-065 · Error Handling & Reliability {#REQ-065}
...
### REQ-069 · Architecture & Design Patterns {#REQ-069}
...
### REQ-070 · Architecture & Design Patterns {#REQ-070}
...
### REQ-071 · Architecture & Design Patterns {#REQ-071}
...
### REQ-072 · Commercial Positioning {#REQ-072}
...
### REQ-169 · Infrastructure {#REQ-169}
...
### REQ-224 · Installer & Packaging {#REQ-224}
...
### REQ-225 · Installer & Packaging {#REQ-225}
...
### REQ-226 · Installer & Packaging {#REQ-226}
...
### REQ-227 · Installer & Packaging {#REQ-227}
...
### REQ-228 · Installer & Packaging {#REQ-228}
...
### REQ-254 · Testing & Quality {#REQ-254}
...
### REQ-255 · Testing & Quality {#REQ-255}
...
### REQ-294 · Installer & Packaging {#REQ-294}
...
### REQ-302 · OpenTelemetry Instrumentation {#REQ-302}
...
### REQ-303 · OpenTelemetry Instrumentation {#REQ-303}
...
### REQ-528 · Infrastructure {#REQ-528}
...
### REQ-539 · Infrastructure {#REQ-539}
...
### REQ-545 · OpenTelemetry Instrumentation {#REQ-545}
...
### REQ-546 · OpenTelemetry Instrumentation {#REQ-546}
...
### REQ-547 · OpenTelemetry Instrumentation {#REQ-547}
...
### REQ-548 · OpenTelemetry Instrumentation {#REQ-548}
...
### REQ-549 · OpenTelemetry Instrumentation {#REQ-549}
...
### REQ-559 · Infrastructure {#REQ-559}
...
### REQ-560 · Installer & Packaging {#REQ-560}
...
### REQ-561 · Installer & Packaging {#REQ-561}
...
### REQ-563 · Installer & Packaging {#REQ-563}
...
### REQ-564 · Infrastructure {#REQ-564}
...
**Use case:** Org registry and user membership model — the provisioning anchor consumed by [REQ-695](#REQ-695) (schema creation) and [REQ-699](#REQ-699) (PG role creation). The orgs table and user_org_memberships remain valid under the schema-per-org model; the org_id FK columns on domains/roles do not.

**Code:** `provisa/core/schema.sql`, `provisa/api/admin/orgs_router.py`

**Tests:** `tests/unit/test_core_registration.py`

### REQ-593 · Multi-Tenancy {#REQ-593}
...
### REQ-618 · Infrastructure {#REQ-618}
...
### REQ-619 · Infrastructure {#REQ-619}
...
### REQ-630 · Installer & Packaging {#REQ-630}
...
### REQ-631 · Installer & Packaging {#REQ-631}
...
### REQ-632 · Installer & Packaging {#REQ-632}
...
### REQ-633 · Installer & Packaging {#REQ-633}
...
### REQ-634 · Installer & Packaging {#REQ-634}
...
### REQ-182 · Hasura Migration Converters {#REQ-182}
...
### REQ-183 · Hasura Migration Converters {#REQ-183}
...
### REQ-184 · Hasura Migration Converters {#REQ-184}
...
### REQ-185 · Hasura Migration Converters {#REQ-185}
...
### REQ-186 · Hasura Migration Converters {#REQ-186}
...
### REQ-187 · Hasura Migration Converters {#REQ-187}
...
### REQ-188 · Hasura Migration Converters {#REQ-188}
...
### REQ-189 · Hasura Migration Converters {#REQ-189}
...
### REQ-190 · Hasura Migration Converters {#REQ-190}
...
### REQ-191 · Hasura Migration Converters {#REQ-191}
...
### REQ-192 · Hasura Migration Converters {#REQ-192}
...
### REQ-193 · Hasura Migration Converters {#REQ-193}
...
### REQ-212 · Hasura v2 Parity: Low-Complexity Features {#REQ-212}
...
### REQ-213 · Hasura v2 Parity: Low-Complexity Features {#REQ-213}
...
### REQ-214 · Hasura v2 Parity: Low-Complexity Features {#REQ-214}
...
### REQ-215 · Hasura v2 Parity: Low-Complexity Features {#REQ-215}
...
### REQ-216 · Hasura v2 Parity: Low-Complexity Features {#REQ-216}
...
### REQ-217 · Hasura v2 Parity: Low-Complexity Features {#REQ-217}
...
### REQ-218 · Hasura v2 Parity: Medium-Complexity Features {#REQ-218}
...
### REQ-220 · Hasura v2 Parity: Medium-Complexity Features {#REQ-220}
...
### REQ-221 · Hasura v2 Parity: Medium-Complexity Features {#REQ-221}
...
### REQ-621 · Hasura Migration Converters {#REQ-621}
...
### REQ-623 · Hasura Migration Converters {#REQ-623}
...
### REQ-624 · Hasura Migration Converters {#REQ-624}
...
### REQ-625 · Hasura Migration Converters {#REQ-625}
...
### REQ-626 · Hasura Migration Converters {#REQ-626}
...
### REQ-627 · Hasura Migration Converters {#REQ-627}
...
### REQ-628 · Hasura Migration Converters {#REQ-628}
...
### REQ-629 · Hasura Migration Converters {#REQ-629}
...
### REQ-697 · Multi-Tenancy {#REQ-697}

**Status:** ✅ complete · **Priority:** MUST · **Type:** structural

init_schema() in provisa/core/db.py accepts an org_id parameter. It creates the org_<org_id> schema if not exists, then runs core schema SQL, audit schema SQL, and MV schema SQL within that schema. Called at startup from _init_pg_pool_and_schema() in provisa/api/app.py using ORG_ID env var (default "default").
...
Each org has a dedicated PostgreSQL role named role_<org_id> with USAGE and CREATE on org_<org_id> schema only. The asyncpg pool connects as this role. The role has no access to platform schema or any other org schema.
...
### REQ-700 · Multi-Tenancy {#REQ-700}

**Status:** ✅ complete · **Priority:** MUST · **Type:** structural

Extends [REQ-595](#REQ-595) for on-prem multi-org deployments. Redis cache keys, hot table keys, APQ keys, and query result keys are all prefixed with org_id (org:<org_id>:...) rather than tenant_id. Redis ACL rules scope each org's credentials to their key prefix. One org's cache flush or eviction never touches another org's keys. Requires wiring org_id through check_cache/store_result in cache/middleware.py (the same gap blocking [REQ-595](#REQ-595) completion).

**Use case:** Redis key prefix isolation complements PG schema isolation ([REQ-695](#REQ-695)). Both layers must be independently correct — ACL misconfiguration in one should not cascade to the other.
...
### REQ-702 · Multi-Tenancy {#REQ-702}

**Status:** ✅ complete · **Priority:** MUST · **Type:** structural

Demo init code and static demo assets are org-scoped. _seed_built_in_sources() passes state.org_id to _seed_meta_domain(); _seed_ops_pg() inherits the correct schema via the asyncpg connection pool search_path set by [REQ-695](#REQ-695). Static demo file assets (Parquet, SQLite, CSV) contain no schema references. No migration tool is required — org scoping is handled entirely through the connection pool and seed function wiring.

**Use case:** Demo environments must participate in org isolation ([REQ-695](#REQ-695) through [REQ-701](#REQ-701)) without special-casing. Seeded data lands in org_<org_id> automatically via the pool init hook, ensuring demo deployments and production multi-tenant deployments use the same code path.
...
### REQ-721 · Splunk Connector {#REQ-721}
...
### REQ-722 · Splunk Connector {#REQ-722}
...
### REQ-723 · Splunk Connector {#REQ-723}
...
### REQ-724 · Splunk Connector {#REQ-724}
...
### REQ-725 · Splunk Connector {#REQ-725}
...
### REQ-726 · SharePoint Connector {#REQ-726}
...
### REQ-727 · SharePoint Connector {#REQ-727}
...
### REQ-728 · SharePoint Connector {#REQ-728}
...
### REQ-729 · SharePoint Connector {#REQ-729}
...
### REQ-730 · SharePoint Connector {#REQ-730}
...
### REQ-731 · SharePoint Connector {#REQ-731}
...
### REQ-732 · SharePoint Connector {#REQ-732}
...
### REQ-733 · Aggregate Configuration {#REQ-733}
...
### REQ-734 · Aggregate Configuration {#REQ-734}
...
### REQ-750 · Cypher Query Frontend (Phase AU) {#REQ-750}
...
### REQ-751 · Cypher Query Frontend (Phase AU) {#REQ-751}
...
### REQ-752 · Cypher Query Frontend (Phase AU) {#REQ-752}
...
### REQ-753 · Cypher Query Frontend (Phase AU) {#REQ-753}
...
### REQ-755 · Cypher Query Frontend (Phase AU) {#REQ-755}
...
### REQ-756 · Cypher Query Frontend (Phase AU) {#REQ-756}
...
### REQ-757 · Cypher Query Frontend (Phase AU) {#REQ-757}
...
### REQ-759 · Cypher Query Frontend (Phase AU) {#REQ-759}
...
### REQ-760 · Cypher Query Frontend (Phase AU) {#REQ-760}
...
### REQ-761 · Cypher Query Frontend (Phase AU) {#REQ-761}
...
### REQ-762 · Cypher Query Frontend (Phase AU) {#REQ-762}
...
### REQ-763 · Cypher Query Frontend (Phase AU) {#REQ-763}
...
### REQ-764 · Cypher Query Frontend (Phase AU) {#REQ-764}
...
### REQ-765 · Cypher Query Frontend (Phase AU) {#REQ-765}
...
### REQ-766 · Cypher Query Frontend (Phase AU) {#REQ-766}
...
### REQ-767 · Cypher Query Frontend (Phase AU) {#REQ-767}
...
### REQ-768 · Cypher Query Frontend (Phase AU) {#REQ-768}
...
### REQ-769 · Cypher Query Frontend (Phase AU) {#REQ-769}
...
### REQ-770 · Cypher Query Frontend (Phase AU) {#REQ-770}
...
### REQ-771 · Cypher Query Frontend (Phase AU) {#REQ-771}
...
### REQ-773 · Cypher Query Frontend (Phase AU) {#REQ-773}
...
### REQ-774 · Cypher Query Frontend (Phase AU) {#REQ-774}
...
### REQ-775 · Cypher Query Frontend (Phase AU) {#REQ-775}
...
### REQ-776 · Cypher Query Frontend (Phase AU) {#REQ-776}
...
### REQ-777 · Cypher Query Frontend (Phase AU) {#REQ-777}
...
### REQ-778 · Cypher Query Frontend (Phase AU) {#REQ-778}
...
### REQ-779 · Graph Explorer {#REQ-779}
...
### REQ-780 · Graph Explorer {#REQ-780}
...
### REQ-781 · Graph Explorer {#REQ-781}
...
### REQ-782 · Graph Explorer {#REQ-782}
...
### REQ-783 · Graph Explorer {#REQ-783}
...
### REQ-784 · Cypher Graph Analytics {#REQ-784}
...
### REQ-785 · Cypher Graph Analytics {#REQ-785}
...
### REQ-786 · Cypher Graph Analytics {#REQ-786}
...
### REQ-790 · File & Lake Sources {#REQ-790}
...
### REQ-791 · File & Lake Sources {#REQ-791}
...
### REQ-800 · UI Explorer Pages {#REQ-800}
...
### REQ-801 · UI Explorer Pages {#REQ-801}
...
### REQ-804 · Protocol Support {#REQ-804}
...
### REQ-807 · Protocol Support {#REQ-807}
...
### REQ-808 · Query Governance {#REQ-808}
...
### REQ-809 · SQLGlot Transpilation {#REQ-809}
...
### REQ-810 · Materialized Views {#REQ-810}
...
### REQ-812 · API & Integration {#REQ-812}
...
### REQ-816 · Docker Compose Organization {#REQ-816}
...
### REQ-817 · Trino Memory Management {#REQ-817}
...
### REQ-818 · Cypher Mutations {#REQ-818}
...
### REQ-820 · Live Query Routing {#REQ-820}
...
### REQ-821 · Live Delivery Mechanisms {#REQ-821}
...
### REQ-822 · Live Delivery Mechanisms {#REQ-822}
...
### REQ-823 · Live Delivery Configuration {#REQ-823}
...
### REQ-824 · Live Delivery Mechanisms {#REQ-824}
...
### REQ-828 · Deployment & Infrastructure {#REQ-828}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** structural

Pluggable admin/metadata store, decoupled from Postgres, selected via a SQLAlchemy-compliant URI. The control-plane store (sources, domains, registered tables, columns, naming rules, governance config) plus the OpenAPI/GraphQL cache substrate must run on an embedded engine (DuckDB or SQLite) with zero external infra on a developer desktop, and on Postgres in production — same schema, same behavior. This is required for the desktop deployment model in [REQ-825](#REQ-825) (PG today requires Docker, which breaks the zero-infra laptop story). Three couplings must be removed: (1) DRIVER — repositories take asyncpg.Connection directly (provisa/core/repositories/source.py) and the pool factory is asyncpg-only (provisa/core/db.py); these move behind a store abstraction driven by a SQLAlchemy URI. (2) DIALECT — schema.sql uses Postgres-specific DDL (SERIAL, JSONB); metadata DDL must be dialect-neutral. (3) META-GOVERNANCE RLS — the hard gate: _init_meta_rls (provisa/api/app.py, [REQ-041](#REQ-041)/[REQ-402](#REQ-402)) enforces control-plane governance via Postgres row-level security, which DuckDB/SQLite lack. Meta-RLS enforcement MUST move from the database into the app layer so control-plane governance is store-independent (the same parity principle as [REQ-827](#REQ-827), applied to the admin DB). Until meta-RLS is app-enforced, embedded stores cannot be certified for production. On desktop the OpenAPI/GraphQL cache lands in the embedded store rather than a Docker Postgres; where Postgres exists (prod) the existing pg_cache path is unchanged and DuckDB may ATTACH it ([REQ-826](#REQ-826)). This store is the TENANT CONTROL PLANE REGISTRY ([REQ-830](#REQ-830)) — per-tenant, distinct from the PLATFORM CONTROL PLANE REGISTRY (tenant directory, federation-engine registry, platform governance). The meta-RLS move generalizes to a single app-layer tenant-isolation boundary enforced across all tenant-scoped stateful components, since swappable media (Redis, DuckDB, S3) have no native RLS.
...
### REQ-830 · Deployment & Infrastructure {#REQ-830}
...
### REQ-832 · Data Model & Persistence {#REQ-832}
...
### REQ-833 · Data Model & Persistence {#REQ-833}
...
### REQ-834 · Data Model & Persistence {#REQ-834}
...
### REQ-835 · Data Model & Persistence {#REQ-835}
...
### REQ-836 · Docker Composition & Deployment {#REQ-836}
...
### REQ-837 · Data Model & Persistence {#REQ-837}
...
### REQ-839 · Data Model & Persistence {#REQ-839}
...
### REQ-840 · Federation Engine Abstraction {#REQ-840}
...
### REQ-841 · Federation Engine Abstraction {#REQ-841}
...
### REQ-843 · Connector Abstraction {#REQ-843}
...
### REQ-844 · Materialization Store {#REQ-844}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** structural

materialization_store — materialized (landed physically by ANY write means: engine-native CTAS/load, SQLAlchemy upsert, or app-side land; [REQ-848](#REQ-848)) into a durable STORE. Configured through the same ${env:...} secrets chokepoint as ControlPlaneConfig. Its members are characterized by three properties that together exclude every other cache: FEDERATABLE (the engine reads it as a real relation it can join/scan — [REQ-826](#REQ-826); excludes hot tables, which are VALUES-CTE plan injections, and the APQ/result memos, which are not relations); DURABLE (survives restart, disk/object-backed — excludes the ephemeral tier); and REFRESHABLE (actively kept in sync by the one centralized freshness gate — [REQ-855](#REQ-855)/856/857/858; excludes a passive scanned source, which is federatable and durable but unmanaged). It holds TWO ROLES on ONE categorical axis — whether the entry has a semantic-SQL definition: (1) REPLICA — undefined verbatim copies of source rows, no standalone identity; governance/derivation applied at query time on top, never baked in. Two population profiles: reactive (source is UNREACHABLE — landed so it is queryable at all; on-miss, single-flighted pull-through; [REQ-845](#REQ-845)/847; formerly api_cache, renamed as the role is source-agnostic) and warm (source is REACHABLE — an optional latency copy; usage-promoted/demoted by query frequency; [REQ-238](#REQ-238)/239). (2) VIEW — mv: governed, named datasets each defined by semantic SQL (view_sql; implicit relationship-generated or explicit view materialize:true). The definition IS the identity and the basis for lineage, provenance ([REQ-862](#REQ-862)), and definition-versioning. Two orthogonal, ENGINE-RELATIVE attributes apply to any entry and are NOT roles: PLACEMENT — where the entry lands, chosen relative to engine capability (object store, a low-latency fast-read tier, engine-native store, or Iceberg); warm's "fast tier" is just placement=engine's-low-latency-store (Trino realizes it as the Iceberg results catalog + local-SSD file cache, other engines differently), never a Trino-specific definition. FRESHNESS POLICY — TTL / probe / transitive ([REQ-855](#REQ-855)). Population trigger and eviction are NOT roles: both roles are lazy and use the one freshness method; the view background refresh loop and warm's frequency promotion are optional warm-ahead only. SUBSTRATE is selected independently per role (roles may occupy distinct schemas of one backend OR distinct backends), engine-capability-gated ([REQ-846](#REQ-846)): replica → a relational/engine-native store suffices (undefined copies have no forensic value); view → SQLAlchemy DB OR engine-native Iceberg, defaulting to Iceberg whenever a reachable Iceberg catalog exists, because the derived dataset's snapshot history is the forensic/bitemporal value (time-travel, provenance, restatement; [REQ-372](#REQ-372)/862). Iceberg view refresh MUST use overwrite semantics — one clean snapshot per refresh (not delete+insert) — so time-travel maps exactly one snapshot to one refresh state. When no Iceberg catalog is reachable the substrate degrades to the relational/native store as an explicit, surfaced capability signal (never a silent fallback; [REQ-847](#REQ-847)).
...
### REQ-845 · Materialization Store {#REQ-845}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

The set of sources served by reactive replicas is engine-relative — reactive = { source : reach(source) == land } for the configured federation engine — generalizing the previously hardcoded REST/GraphQL/gRPC pull-through set (renamed from api_cache; the role is source-agnostic). Pull-through is TTL/freshness-gated (per the [REQ-855](#REQ-855) freshness policy) and single-flighted to prevent upstream stampede on concurrent misses. DONE (2026-07): the engine-relative reactive set is derived — provisa/federation/materialization.py:: reactive_sources returns { source.id : federate(source, engine) is MATERIALIZED }, so the pull-through set is a function of engine reach (a VIRTUAL/SCAN source is never a reactive replica; an unreachable source is excluded). REMAINING (kept in-progress): the TTL/freshness-gated, single-flighted pull-through execution that lands rows into the store on miss — lands with the write face ([REQ-848](#REQ-848)) and the freshness gate ([REQ-855](#REQ-855)).

**Code:** `provisa/federation/materialization.py`, `provisa/federation/strategy.py`

**Tests:** `tests/unit/test_federation_materialization.py`, `tests/integration/test_materialization_store_lifecycle_e2e.py`

### REQ-846 · Materialization Store {#REQ-846}
...
### REQ-848 · Materialization Store {#REQ-848}
...
### REQ-849 · Views (Governed Computed Datasets) {#REQ-849}
...
### REQ-850 · Control-Plane Store Portability {#REQ-850}
...
### REQ-851 · Multi-Tenant Org Isolation {#REQ-851}
...
### REQ-852 · Multi-Tenant Org Isolation {#REQ-852}
...
### REQ-853 · Control-Plane Store Portability {#REQ-853}
...
### REQ-854 · Release Artifact Packaging {#REQ-854}
...
### REQ-857 · Freshness Module {#REQ-857}

**Status:** ✅ complete · **Priority:** MUST · **Type:** structural

FreshnessSubject protocol exposes: (1) last-refresh timestamp; (2) last-refresh outcome (success/failure); (3) upstream-subject handles for transitive freshness; (4) content-query capability — this IS [REQ-855](#REQ-855)'s freshness_token(source,table) -> str | None dispatch (opaque token; None = source cannot produce one, degrades to TTL per [REQ-847](#REQ-847)).
...
### REQ-858 · Freshness Module {#REQ-858}

**Status:** ✅ complete · **Priority:** MUST · **Type:** structural

FreshnessPredicate with pluggable strategies that unify [REQ-855](#REQ-855)'s three modes plus a boolean content predicate: TTL (time-based, exists today); PROBE ([REQ-855](#REQ-855) opaque- token change detection via freshness_token — the same mechanism as [REQ-855](#REQ-855)'s DB-SQL steward-query transport, do not treat as a separate "SQL strategy"); TRANSITIVE (fresh iff own predicate holds AND all upstream subjects are transitively fresh — the one net-new capability beyond [REQ-855](#REQ-855), which is per-entry only); composable (TTL+PROBE floors probe frequency). Caller supplies subject and strategy; predicate returns decision without side effects.
...
### REQ-859 · Freshness Module {#REQ-859}

**Status:** ✅ complete · **Priority:** MUST · **Type:** behavioral

MV and the ad-hoc API/pg cache freshness checks (provisa/openapi/pg_cache.py) become FreshnessSubjects (via the StateSubject adapter) and delegate their TTL decision to the one unified FreshnessPredicate. MVDefinition.is_fresh_at keeps its FRESH-status lifecycle gate and delegates the TTL comparison; pg_cache._is_fresh delegates likewise. Behaviour-preserving unification of the scattered TTL logic. Source-level conformance is the gating work in [REQ-860](#REQ-860) (its interesting PROBE mode depends on the [REQ-855](#REQ-855) probe transport).
...
### REQ-860 · Freshness Gating {#REQ-860}
...
### REQ-861 · Freshness Gating {#REQ-861}

**Status:** ✅ complete · **Priority:** MAY · **Type:** behavioral

File-based sources (CSV, Parquet, etc.) may carry an optional producer command (argv) that runs on-stale (gate-triggered) before the file is read. Allows refresh without modifying the file path or materializing into an MV. DONE (2026-07) - a file source (csv/parquet/sqlite/files) carries an optional producer_command argv (provisa/core/models.py); provisa/freshness/producer.py runs it with shell=False (injection-safe) and fails loud on a non-zero exit. The read path (provisa/events/source_loader.py SourceRowLoader.load) is invoked only after the [REQ-860](#REQ-860) source gate reports stale, so it runs the producer BEFORE the file read - freshening the file in place without touching path or defining an MV.

**Use case:** Supports workflows where stale file detection should trigger a script to refresh the file in place. Example: fetch latest data from an upstream API and write to the same CSV path when staleness is detected. Pairs with [REQ-855](#REQ-855): [REQ-855](#REQ-855) file mtime DETECTS staleness, this producer command is the ACT-on-stale response.
...
### REQ-863 · Query Planning Pipeline {#REQ-863}
...
### REQ-864 · Query Result Cache {#REQ-864}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** structural

The query result cache key is computed from a NORMALIZED IR — a canonical, AST-normalized form of the GOVERNANCE-NORMALIZED IR (the post-Stage-2 governed SQL — [REQ-263](#REQ-263) — after RLS, masking, and column visibility are applied with per-identity values resolved, [REQ-041](#REQ-041)/[REQ-402](#REQ-402)) — rather than the serialized compiled-SQL string it hashes today (provisa/cache/key.py hashes compiled.sql as text). Normalization canonicalizes cosmetic variation that does not change results (whitespace, alias naming/ordering, literal formatting, commutable predicate/JOIN ordering, projection ordering) so two semantically-identical queries resolve to the SAME cache entry instead of missing. Because the keyed form is the governed IR, the resolved persona — role, RLS predicate values, masking, and column visibility — is ALREADY embedded in it (no separate concatenation), and the per-tenant prefix ([REQ-595](#REQ-595)) is applied on top; the RLS-unresolved guard (key.py ValueError) is retained. CRITICAL: normalization canonicalizes cosmetic/structural form ONLY and MUST preserve every identity-encoding element — the RESOLVED RLS predicate values, role, masking, and column visibility — so it can never collapse two personas onto one key (the hypercritical isolation constraint [REQ-866](#REQ-866)). Refines, does not replace, the existing result cache ([REQ-544](#REQ-544)).
...
### REQ-865 · Query Routing {#REQ-865}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** structural

The route decision includes CACHED as a first-class route alongside DIRECT ([REQ-027](#REQ-027)) and FEDERATED/Trino ([REQ-028](#REQ-028)): the Route enum gains Route.CACHE and decide_route (provisa/transpiler/router.py) evaluates the result cache — keyed per [REQ-864](#REQ-864)/[REQ-544](#REQ-544) — as the first candidate route. A cache hit resolves to Route.CACHE and serves the stored result with no direct or federated execution; a miss falls through to DIRECT/FEDERATED as today. This elevates the current outer-wrapper cache check (which runs before decide_route in endpoint.py and is invisible to routing) into the routing model, so every query is served by exactly one uniformly-decided route: {cached, direct, federated}. CACHED belongs in the route decision precisely BECAUSE the routing point is where the query is GOVERNANCE-NORMALIZED: routing consumes the post-Stage-2 governed IR ([REQ-263](#REQ-263), persona-resolved via [REQ-041](#REQ-041)/[REQ-402](#REQ-402)), so the cache key derived there ALREADY encodes the requester's persona and a cache serve is inherently isolated ([REQ-866](#REQ-866)) — a pre-governance wrapper cannot guarantee that structurally. The no-cache bypass (@noCache / no_cache / @cached(ttl:0); [REQ-544](#REQ-544)) removes CACHED from the candidate set for that query. Routing consumes the post-optimization IR ([REQ-863](#REQ-863)), so cache-key computation and route selection operate on the same normalized form.
...
### REQ-866 · Cache Isolation {#REQ-866}

**Status:** ✅ complete · **Priority:** MUST · **Type:** constraint

HYPERCRITICAL isolation invariant for the query result cache. The cache key MUST fully partition by the RESOLVED governance identity of the requester, so a cache hit can NEVER serve rows computed for a different persona. This matters because personas can switch on the same device, connection, or pooled session; a mis-scoped key would leak one user's data to another. The key MUST bind to: the per-tenant prefix ([REQ-595](#REQ-595)), role_id, and the fully-RESOLVED RLS predicates plus masking and column visibility — i.e. RLS current_setting/session values substituted to their actual per-identity values ([REQ-041](#REQ-041)/[REQ-402](#REQ-402)), NOT the unresolved rule template (identical across users, which would collapse distinct personas onto one key). This isolation is STRUCTURAL when the cache is a first-class route ([REQ-865](#REQ-865)): the route decision operates on the governance-normalized IR, so the key intrinsically encodes the persona. IR/SQL normalization ([REQ-864](#REQ-864)) canonicalizes cosmetic and structural form ONLY and MUST preserve every identity-encoding element. FAIL-CLOSED: if any identity dimension is unresolved or unknown, the cache MUST NOT be read or written for that query (the key.py RLS-unresolved guard), and CACHED ([REQ-865](#REQ-865)) is removed from the candidate routes — never a silent fallback that could serve another persona's data.

**Use case:** Prevents cross-persona / cross-user data leakage through the result cache when identities change on a shared device, connection, or pooled session — a hard multi-tenant and RLS isolation guarantee, consistent with the two-layer governance model ([REQ-038](#REQ-038)) and Stage-2 RLS/masking enforcement ([REQ-263](#REQ-263)).
...
### REQ-873 · Subscriptions {#REQ-873}

**Status:** ✗ rejected · **Priority:** MUST · **Type:** behavioral

SUPERSEDED BY [REQ-874](#REQ-874). This requirement duplicated existing watermark/probe change-signal work already captured in [REQ-855](#REQ-855) (probe transport, opaque token comparison), [REQ-260](#REQ-260) (RDB watermark_column polling), and [REQ-282](#REQ-282) (Live Query Engine polling). Its only net-new capability (incremental delta fetch/append to materialized replicas instead of full re-pull) is now carried by [REQ-874](#REQ-874), which generalizes delta-fetch to any federated dataset and separates WATERMARK (existing change-signal) from DELTA (the new incremental append). This entry is retired; use [REQ-874](#REQ-874) and [REQ-855](#REQ-855) instead.
...
### REQ-875 · Query Routing {#REQ-875}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

Cheap-count route: a count(*)-shaped query over an UNMATERIALIZED source that exposes an EXACT native count ([REQ-673](#REQ-673) cardinality capability) is routed to the native count call instead of materializing the full dataset to count it. Parallels Route.CACHE ([REQ-865](#REQ-865)) — a query shape that resolves to a first-class route bypassing the expensive path. Today SELECT count(*) over a cold API source pulls the entire dataset (endpoint.py _materialize_api_to_trino_cache) to count it; with an exact native count it becomes a single call. THREE GUARDS, all required. (1) SHAPE: a bare count(*) with no other projection and no WHERE the native call cannot honor; a filtered count the source cannot filter falls back to materialize. (2) EXACTNESS: fires only when the cardinality Estimate is exact; approximate statistics stay in the planner/human-hint lane and are never served as the answer to count(*). (3) GOVERNANCE: the route MUST NOT bypass Stage-2 RLS/masking ([REQ-263](#REQ-263)) — when an RLS predicate applies to the table for the requesting persona a native total count would over-count the visible subset, so the route is disabled and falls back to materialize+count. Fail-closed, the same discipline as cache isolation ([REQ-866](#REQ-866)). DONE (2026-07): the three-guard route decision is implemented — provisa/federation/cardinality.py:: can_route_cheap_count(is_bare_count_star, estimate, rls_applies) fires only when the shape is a bare count(*), the [REQ-673](#REQ-673) estimate is EXACT with a value, and NO RLS predicate applies to the persona; any guard failing returns False (fail-closed → materialize+count). REMAINING (kept in-progress): wiring it into the endpoint count(*) path so an exact-native-count source answers with one call instead of _materialize_api_to_trino_cache.
...
### REQ-876 · Deployment & Infrastructure {#REQ-876}
...
### REQ-880 · Materialization Store {#REQ-880}
...
### REQ-881 · Materialization Store {#REQ-881}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

Probe-based freshness gate on the MV REFRESH path, opt-in per MV — the refresh-time application of [REQ-855](#REQ-855)'s centralized freshness gate to the materialized-view role. MOTIVATION: relationship-based (join-pattern) MVs are expensive to rebuild — a full Trino CTAS / DELETE+INSERT of the join every cycle. Today the background refresh loop gates purely on TTL (MVRegistry.get_due_for_refresh compares now - last_refresh_at >= refresh_interval), so a due MV pays the full rebuild every interval EVEN WHEN NO SOURCE CHANGED. FIX: add a per-MV freshness_mode (ttl [default, current behavior] | probe | ttl_probe). For probe / ttl_probe, before the expensive materialization the refresh computes an opaque per-MV change token from the [REQ-862](#REQ-862) per-source input signals (Iceberg snapshot id / RDB watermark MAX, already gathered by provisa/mv/input_signals.py::gather_input_signals) and compares it by equality to the token stored at last refresh: unchanged → skip the rebuild, reset the TTL, keep the materialized rows and FRESH status (zero lag at probe cost); changed → rebuild and store the new token. ttl_probe probes only after the TTL floor elapses (caps probe frequency); probe re-checks every loop ignoring TTL. SAFETY: a token is usable only when EVERY source produces one (len(signals) == len(source_tables)); if any source is token-less the entry degrades to TTL and rebuilds normally — never skip on partial signal ([REQ-855](#REQ-855) None-degrades-to-TTL, [REQ-847](#REQ-847) capability-signal-not-silent-fallback). Opt-in is per MV so cheap MVs keep plain TTL and only expensive relationship MVs pay the probe. Mutual exclusivity with delta ([REQ-874](#REQ-874)) and the shared coordination catalog ([REQ-879](#REQ-879)) follow [REQ-855](#REQ-855): the same materialized_input_version stamp is the probe token and the dedup key.
...
### REQ-882 · Materialization Store {#REQ-882}
...
### REQ-883 · Federation Engine Abstraction {#REQ-883}
...
### REQ-887 · RDBMS Stored Procedure Auto-Discovery {#REQ-887}
...
### REQ-888 · Execution & Routing {#REQ-888}
...
### REQ-892 · Connector Abstraction {#REQ-892}
...
### REQ-895 · Federation Engine Abstraction {#REQ-895}
...
### REQ-896 · Federation Architecture {#REQ-896}
...
### REQ-897 · Federation Architecture {#REQ-897}
...
### REQ-901 · PostgreSQL Deployment {#REQ-901}
...
### REQ-907 · Source Connectors {#REQ-907}
...
### REQ-908 · Source Connectors {#REQ-908}
...
### REQ-910 · Multi-Route Write Dispatch {#REQ-910}
...
### REQ-911 · ClickHouse Federation Engine {#REQ-911}
...
### REQ-912 · ClickHouse Federation Engine {#REQ-912}
...
### REQ-913 · AST-Based Transforms {#REQ-913}
...
### REQ-924 · Source Watermarking {#REQ-924}
...
### REQ-925 · Source Watermarking {#REQ-925}
...
### REQ-926 · Change Subscriptions {#REQ-926}
...
### REQ-928 · Change Subscriptions {#REQ-928}
...
### REQ-929 · Change Signals {#REQ-929}
...
### REQ-931 · Change Subscriptions {#REQ-931}
...
### REQ-932 · Change Detection Strategy {#REQ-932}
...
### REQ-933 · Execution & Routing {#REQ-933}
...
### REQ-934 · Materialization Store {#REQ-934}
...
### REQ-935 · Materialization Store {#REQ-935}
...
### REQ-936 · Live Data & Events {#REQ-936}
...
### REQ-937 · Execution & Routing {#REQ-937}
...
### REQ-938 · Execution & Routing {#REQ-938}
...
### REQ-939 · Execution & Routing {#REQ-939}
...
### REQ-941 · Live Data & Events {#REQ-941}
...
### REQ-942 · Live Data & Events {#REQ-942}
...
### REQ-944 · Schema Discovery {#REQ-944}
...
### REQ-945 · Live Data & Events {#REQ-945}
...
### REQ-947 · Connector Abstraction {#REQ-947}
...
### REQ-948 · Driver Management {#REQ-948}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

Driver availability is per-connector data, not new machinery: Connector.runtime_deps entries are tagged by who provides the driver — "system" (OS-provided), "bundled" (Provisa ships + relocates it), "operator" (BYO, must install) — and Connector.probe() ([REQ-904](#REQ-904)) reports functional availability + operator remediation. A source is shown in the dropdown but rendered disabled with its remediation when its driver is operator-provided and not installed. Bundled subset Provisa distributes: postgres (libpq), duckdb (libduckdb), sqlite (system libsqlite3), csv, parquet, iceberg, sqlserver, mysql, plus any source reachable via SQLAlchemy fallback driver. Niche drivers (e.g. oracle, some SaaS) stay operator/BYO.
...
### REQ-949 · Connector Abstraction {#REQ-949}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** structural

Structural debt: provisa/federation/connector.py and provisa/federation/engine.py are monoliths that do not scale as more federation engines are added. Split them into per-engine modules (e.g. provisa/federation/connectors/<engine>.py and per-engine engine builders) before/as new engines land.
...
### REQ-950 · Wire-compatible RDB Families {#REQ-950}
...
### REQ-951 · Connector Abstraction {#REQ-951}
...
### REQ-952 · Source Type Availability {#REQ-952}
...
### REQ-954 · Replica Strategy {#REQ-954}
...
### REQ-955 · Replica Strategy {#REQ-955}

**Status:** ✅ complete · **Priority:** MUST · **Type:** structural

Each pgwire server is configured via model/model.json in the bundle with source-specific credentials and storage paths: files → directory (or S3 storageType + storageConfig + AWS env vars); sharepoint → siteUrl, tenantId, clientId, clientSecret (or cert/device-code); splunk → url (or host/port/protocol), token or username/password, app. Provisa manages server lifecycle (start/health/stop) per source. Each server is allocated a unique --port (default 5433) and --calcite-child host:port (default 127.0.0.1:5533) to enable concurrent execution without collision; port allocation is handled transparently by the pgwire-<connector> CLI wrapper (./bin/pgwire-<connector> --port <N> copies args into python -m pgwire_calcite.launcher). No PGWIRE_PORT env var exists; only --port CLI flag and PGWIRE_PYTHON/PGWIRE_HOME/PGWIRE_CALCITE_CLASSPATH* env vars.
...
### REQ-956 · Replica Strategy {#REQ-956}
...
### REQ-958 · Derived / MV Processor {#REQ-958}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

Temporal MVs are expressed as completeness-gated processing windows, not a separate snapshot pipeline. A node's required-input set is its declared expected-events list ([REQ-961](#REQ-961)), defaulting to all SQL-lineage inputs (extract_inputs, [REQ-939](#REQ-939)), verified as a freshness contract at fire time (no NO_CHANGE events). A window opens on the first fanned-in event, gathers and coalesces subsequent events (fan-in collapse), and fires at the claim's deadline (window.end + allowed_lateness). produce reads as-of ctx.window.end (never now(), to stay deterministic and replayable); the result lands as an append keyed on the window boundary (accumulating lineage), so a point-in-time snapshot (e.g. daily sales) is a read-time filter over the accumulating MV. Matching "received for this window" REQUIRES a window/epoch tag stamped on each event at emit time. Late data policy is per-node: drop, or emit a correction partition (never rewrite a sealed one). A window pegs by time and aligns time-keyed inputs; joins across inputs with no common time key still need frontier machinery. The accumulating-append + read-time-filter form serves PIT as a VIEW over retained RT history and therefore stays INSIDE the NRT ideal ([REQ-966](#REQ-966)) — it is reconstructible, not a departure; the departure line is reconstructible-vs-frozen, and a PIT dataset that CANNOT be rebuilt from current state plus retained event history is a preserved, sealed snapshot ([REQ-983](#REQ-983)), not this.
...
### REQ-959 · Table Processor (Shared) {#REQ-959}
...
### REQ-960 · Table Processor (Shared) {#REQ-960}
...
### REQ-964 · Data-Model-Driven Estate {#REQ-964}

**Status:** ✅ complete · **Priority:** MUST · **Type:** structural

The materialization estate is DATA-MODEL-DRIVEN, not process-driven — the key differentiator. You declare the authoritative, governed data you want represented (each MV as SQL) and the RULES for processing/reprocessing (expected-events freshness contract [REQ-961](#REQ-961), calendar/grain [REQ-962](#REQ-962), deadline/debounce [REQ-959](#REQ-959)/[REQ-963](#REQ-963), preprocess [REQ-957](#REQ-957)); the system DERIVES the process — lineage from SQL ([REQ-939](#REQ-939)), fan-out, scheduling, and failover — with nothing hand-orchestrated. This inverts the imperative pipeline model (dbt/Airflow author the process; the data model is emergent) and yields a single, almost- PROVABLE data estate: a deterministic function of (governed sources, SQL definitions, rules). "Almost" is bounded by five explicit PROOF OBLIGATIONS, each pushable toward mechanical enforcement: (1) transform determinism — MV SQL and preprocess must be pure (reject now()/random at registration; sandbox from wall-clock); (2) source freshness honesty — the one irreducible trust boundary, "trusted" is relative to what a source reports; (3) land idempotency on the window key — exactly-one-effect under the store/queue two-database split rests on this + ownership CAS ([REQ-960](#REQ-960)), not a distributed transaction; (4) temporal-join correctness — the barrier guarantees input availability, not point-in- time-correct (SCD-2) joins, which are the SQL author's obligation (lintable); (5) calendar immutability — replay fidelity requires holiday/fiscal data immutable-per-window ([REQ-962](#REQ-962)). Close 1/3/5 mechanically, lint 4, and the estate is provable except where a source lies — the strongest guarantee a federated estate can make.
...
### REQ-967 · Data-Model-Driven Estate {#REQ-967}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** structural

The estate is SELF-DESCRIBING: because every change is an event and every derived dataset is an MV, the system's OWN operational metadata is emergent — each operational concern is just an MV over streams the machinery already emits, with no bespoke subsystem. Catalog: DQ / quality = an MV over the warn/error emissions ([REQ-957](#REQ-957), [REQ-941](#REQ-941)), append-keyed → a scorecard and quality history; HISTORY / SCD-2 = an MV over an append emission from a replace-persist upstream ([REQ-965](#REQ-965)) → a time series, which also RETIRES proof-obligation #4 ([REQ-964](#REQ-964)) — the SCD-2 dataset IS the point-in-time-correct dimension, so temporal joins become a declared dataset instead of an unenforced author burden (this reconstructible SCD-2 view is PIT inside the ideal; a frozen, non-reconstructible snapshot is the [REQ-983](#REQ-983) departure); FRESHNESS / VINTAGE = an MV over the freshness-contract state ([REQ-961](#REQ-961)) → an SLA / as-of dashboard with queryable outage detection; LINEAGE / IMPACT = an MV over the SQL-derived DAG edges ([REQ-939](#REQ-939)) → impact analysis; AUDIT / PROVENANCE = an MV over the durable event log ([REQ-960](#REQ-960) queue) → a replayable operational trail; CHURN / COST = an MV over fire and debounce-collapse events ([REQ-963](#REQ-963)) → a tuning dashboard; CONFIG MATURITY = an MV over why-tagged config ([REQ-966](#REQ-966)) → the distance-from-NRT map. The meta-level (how the estate operates) folds into the object- level (governed MVs) — the estate observes itself with its own machinery, so quality, history, freshness, lineage, audit, and cost are first-class governed data, governed and lineage-tracked like any other dataset. This reflexivity is the COMPLETENESS TEST for the primitive set (you cannot reach outside it to describe it) and the strongest form of the [REQ-964](#REQ-964) thesis: a new operational capability is a DECLARATION — an MV over an existing stream — never a new code path or a separate DQ / history / audit subsystem.
...
### REQ-968 · Derived / MV Processor {#REQ-968}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

Forced regen / replay recomputes a derived node — or an addressable calendar window (e.g. 2026-Q1, [REQ-962](#REQ-962)) — ON DEMAND, bypassing the token/no-op gate ([REQ-958](#REQ-958)). Scope selection: by SOURCE (regen the roots and let lineage fan-out cascade forward — the natural, always-correct form), by MV NODE (regen a specific derived node without re-landing its sources — for a changed SQL def), or by WINDOW-ID (regen one sealed period). It posts synthetic events marked forced ({forced:true, reason, scope}); a forced event MUST bypass the no-op gate (it recomputes regardless of change) yet still runs preprocess ([REQ-957](#REQ-957)) and honors the output outcomes ([REQ-965](#REQ-965)). The forward cascade is the normal fan-out — dependents recompute in topological order. Idempotent land on the window key ([REQ-960](#REQ-960)) makes replay exactly-once; determinism ([REQ-964](#REQ-964) obligation 1) + calendar-addressable windows ([REQ-962](#REQ-962)) make a window regen EXACT — it recomputes precisely that period from its as-of inputs. Forced events are marked for audit ([REQ-967](#REQ-967)) so a replay is distinguishable from an organic change.
...
### REQ-969 · Derived / MV Processor {#REQ-969}

**Status:** ✅ complete · **Priority:** MAY · **Type:** behavioral

Incremental maintenance computes a derived node's output from an upstream DELTA instead of a full recompute — the cost axis that makes emit=delta ([REQ-965](#REQ-965)) worth declaring. When an input arrives as delta/append ([REQ-932](#REQ-932)/[REQ-965](#REQ-965)), an incrementally-maintained MV applies only the changed rows to its prior landed state (persist=upsert/append) and emits the resulting delta, rather than re-running the full SELECT. Feasibility is per-MV and OPERATOR-DECLARED: it is expressible only when the SQL admits an incremental form (many aggregations/joins do via delta rules; some do not) and a PK exists for row identity — a declared-but-infeasible incremental MV is an EXPLICIT ERROR, never a silent fall-back to full recompute ([REQ-964](#REQ-964); a silent fall-back hides cost). Realized either as author-provided incremental SQL or a system delta-rule derivation where the SQL shape permits. Recompute-to-current stays the DEFAULT ([REQ-966](#REQ-966) NRT baseline); incremental is the resource-concession config that lowers per-fire cost for large or hot derived nodes. Conflict to declare around: an incrementally-maintained MV cannot freely drop intermediate deltas the way recompute-to-current can, so it partially conflicts with debounce ([REQ-963](#REQ-963)) — the operator chooses per node.
...
### REQ-970 · Derived / MV Processor {#REQ-970}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

A derived node's store-table schema is DERIVED from its SQL SELECT (output column names + types), not taken from a source — the structural contrast with a replica, whose schema comes from its source ([REQ-846](#REQ-846)). At registration the SELECT is analyzed (SQLGlot + type inference, or a describe against the federation engine) to produce the output columns; the MV store table is created/reconciled to that schema via the existing reconcile_table machinery ([REQ-846](#REQ-846)). A definition change that drifts the output schema → RECREATE (drop + reland on next fire), symmetric to source-drift reconcile. A PK for the derived table — required for persist=upsert / emit=delta / incremental ([REQ-965](#REQ-965)/[REQ-969](#REQ-969)) — is operator-declared or inferred from an unambiguous GROUP BY / distinct key; required-but-absent is an explicit error, never a silent replace. The derived schema flows into lineage ([REQ-939](#REQ-939)) so downstream MVs type-check their inputs against it.
...
### REQ-971 · Data Masking & Expression Pushdown {#REQ-971}
...
### REQ-973 · Desktop Installation {#REQ-973}
...
### REQ-974 · Desktop Installation {#REQ-974}
...
### REQ-975 · Desktop Installation {#REQ-975}
...
### REQ-976 · Desktop Installation {#REQ-976}
...
### REQ-977 · Desktop Installation {#REQ-977}
...
### REQ-978 · Desktop Installation {#REQ-978}
...
### REQ-979 · Desktop Installation {#REQ-979}
...
### REQ-981 · Live Data & Events {#REQ-981}
...
A preserved snapshot is a point-in-time dataset that is MATERIALIZED-AND-SEALED because it is NOT reconstructible from current state plus retained event history — the one PIT form that is a genuine DEPARTURE from the NRT ideal ([REQ-966](#REQ-966)), as opposed to the reconstructible PIT of [REQ-958](#REQ-958)/[REQ-965](#REQ-965)/[REQ-967](#REQ-967) (accumulating append + read-time filter) which stays inside the ideal. It is DECLARED, never inferred, and MUST be why-tagged with its [REQ-966](#REQ-966) root cause: RESOURCE — the deriving history was never retained or the source cannot be replayed (debt that retires as retention/replay capability improves); or BUSINESS MANDATE — the output must be frozen exactly as computed at a moment (a definition or upstream changed and the prior result must be preserved as-is; an external filing/attestation fixes the number). The snapshot is landed as an IMMUTABLE, addressable partition (a [REQ-962](#REQ-962) window-id or an explicit snapshot-id), sealed like a calendar window: never rewritten, corrected only by a new partition, replay-exact via determinism ([REQ-964](#REQ-964)) where the inputs still exist, and otherwise preserved verbatim because re-derivation is impossible. Distinct from [REQ-958](#REQ-958)'s accumulating-append history (a reconstructible view over RT) and from a live replace-persist hot table ([REQ-965](#REQ-965)): a preserved snapshot is chosen precisely when derive-from-RT is NOT available. Never a silent fallback — the operator declares it with its root cause, or the estate serves PIT as a view.

**Use case:** Real-world estates cannot always retain full event history or replay every source, and some outputs must be frozen as-computed for audit/attestation — so the platform offers PIT datasets built and preserved at a moment as an explicit, why-tagged departure, keeping derivable PIT the default and making every frozen snapshot a visible entry in the distance-from-NRT ledger ([REQ-966](#REQ-966)).
...
### REQ-987 · Arrow Flight Transport {#REQ-987}
...
### REQ-988 · Arrow Flight Transport {#REQ-988}
...
### REQ-991 · Live Delivery Strategy {#REQ-991}
...
### REQ-992 · Live Delivery Strategy {#REQ-992}
...
### REQ-993 · Live Delivery Strategy {#REQ-993}
...
### REQ-995 · Federation Engine Capabilities {#REQ-995}
...
### REQ-998 · Name Resolution {#REQ-998}
...
### REQ-999 · Name Resolution {#REQ-999}
...
### REQ-1000 · Name Resolution {#REQ-1000}
...
### REQ-1001 · Transaction Safety {#REQ-1001}
...
### REQ-1002 · Type Coercion {#REQ-1002}
...
### REQ-1003 · Scheduled Execution {#REQ-1003}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

Extend the APScheduler-backed ScheduledTrigger (provisa/core/models.py:640) to support execution of a user-supplied SQL statement on its cron schedule, not only webhook POST. When a trigger fires, the SQL statement executes against the federated engine. This enables scheduled CTAS snapshot/archive patterns ([REQ-996](#REQ-996)).
...
### REQ-1004 · Template Substitution {#REQ-1004}

**Status:** ✅ complete · **Priority:** SHOULD · **Type:** behavioral

Scheduled SQL statements support run-time substitution of date/timestamp tokens (e.g., {{yyyymmdd}}, {{YYYY-MM-DD}}, {{iso8601}}, {{timestamp}}) into the statement text before execution. Each run substitutes tokens with that run's execution date/time, enabling scheduled CTAS to produce distinct date-varied table names (e.g., archive.orders_{{yyyymmdd}}) without collision or overwrite, preserving the global schema.table uniqueness invariant ([REQ-998](#REQ-998)) automatically. Depends on [REQ-1003](#REQ-1003).

**Use case:** The snapshot/archive pattern requires each run to produce a uniquely-named table. Date tokens allow users to express target table names declaratively (e.g., archive.orders_{{yyyymmdd}}) so scheduled CTAS automatically creates archive.orders_20260712, archive.orders_20260713, etc. without manual collision detection or user-supplied name-generation logic. This is essential for autonomous time-windowed archives that preserve the model's global schema.table uniqueness ([REQ-998](#REQ-998)) while remaining unregistered semantic entities.
...
### REQ-1005 · Desktop Installation {#REQ-1005}
...
### REQ-1006 · Infrastructure {#REQ-1006}
...
### REQ-1007 · Multi-Tier Deployment {#REQ-1007}
...
**Use case:** Makes Provisa pluggable into Claude and other MCP-speaking agents for governed metadata discovery and SQL execution, without exposing a second ungoverned surface. Extends the governed-surface-for-AI-planners motivation of [REQ-884](#REQ-884) from "queryable telemetry" to a first-class agent-facing protocol. Bottom-up search answers detail-topic questions ("which dataset holds the SOFR reset rate") that structured top-down navigation cannot at enterprise catalog scale where the flat table list exceeds an agent's context window.
...
### REQ-1010 · Design System {#REQ-1010}
...
### REQ-1012 · Internationalization {#REQ-1012}
...
### REQ-1013 · Accessibility {#REQ-1013}
...
### REQ-1014 · Accessibility {#REQ-1014}
...
### REQ-1075 · SaaS Billing {#REQ-1075}
...
### REQ-1076 · Federation Configuration {#REQ-1076}
...
### REQ-1077 · Warehouse Configuration {#REQ-1077}
...
### REQ-1078 · Testing Infrastructure {#REQ-1078}
...
### REQ-1027 · First-Customer Deployment {#REQ-1027}
...
### REQ-1031 · First-Customer Deployment {#REQ-1031}
...
### REQ-1032 · Cost Management {#REQ-1032}
...
### REQ-1040 · Trino Resource Management {#REQ-1040}
...
### REQ-1041 · Trino Scaling & HA {#REQ-1041}
...
### REQ-1042 · Trino Resource Management {#REQ-1042}
...
**Use case:** MV fleet ([REQ-942](#REQ-942)/966) refresh cycles can spike memory and CPU; isolating batch workloads into a separate resource group with relaxed limits ensures interactive queries maintain predictable tail latency. Distinct worker pools (future) enable physical separation and independent scaling.
...
### REQ-1044 · Query Cost Control & Monetization {#REQ-1044}
...
### REQ-1051 · Documentation & Developer Experience {#REQ-1051}
...
### REQ-1052 · Onboarding & Entry Points {#REQ-1052}
...
**Use case:** Single source of truth for tier limits: tier definitions (cost caps, storage quotas) exist once in the runtime entitlement system ([REQ-1044](#REQ-1044)/1046); the pricing page programmatically queries those limits and renders them to users. Eliminates marketing/product drift (manually updated pricing page drifting from actual runtime caps). Ensures all users see accurate tier terms before signup.
...
### REQ-1058 · Public Data Publishing {#REQ-1058}
...
**Use case:** Enables orgs to publish datasets anonymously without requiring end-user authentication. Public role allows intentional, opt-in data sharing without building separate anonymous infrastructure. Distinct from the Firebase-anonymous sandbox uid ([REQ-1034](#REQ-1034)).

**Code:** —

**Tests:** —

### REQ-1059 · Public Data Publishing {#REQ-1059}

**Status:** 💡 proposed · **Priority:** SHOULD · **Type:** behavioral

Publishing is a governance grant, not new machinery: each org has a built-in 'public' role starting with ZERO visibility. Publishing an asset means granting that role visibility to a specific table/view; access then flows through existing visibility/RLS/masking ([REQ-039](#REQ-039)/040) uniformly across GraphQL/SQL/pgwire/Bolt. Nothing is public by default; opt-in and explicit.
...
### REQ-1060 · Public Data Publishing {#REQ-1060}

**Status:** 💡 proposed · **Priority:** MUST · **Type:** constraint

Hard caps on anonymous public traffic: unauthenticated published endpoints are internet-facing with no login gate, so they inherit the tightest rate limits and query-cost caps ([REQ-1044](#REQ-1044)/1045). High-volume public publishing requires a premium public-tier SKU.
...
**Use case:** Provides predictable, usage-based billing that aligns with customer consumption patterns. Tier-based credit pricing allows upsells (pay more per credit for premium support/features). Complements hard caps ([REQ-1044](#REQ-1044)/1046) which define ceilings; meter defines pay-as-you-go below them. Industry-proven model (Starburst, Apollo).

**Code:** —

**Tests:** —

### REQ-1064 · Pricing & Tiering {#REQ-1064}
...
### REQ-1066 · Pricing & Tiering {#REQ-1066}

**Status:** 💡 proposed · **Priority:** SHOULD · **Type:** behavioral

Premium feature gates beyond compute: SSO/SAML + fine-grained access control (ABAC/SCIM, leveraging [REQ-122](#REQ-122)/123/203/204), longer audit/observability retention, private networking, and SLA-backed support are gated to premium tiers.
...
### REQ-1080 · Admin Configuration {#REQ-1080}
...
### REQ-1081 · Admin Configuration {#REQ-1081}
...
### REQ-1082 · Admin Configuration {#REQ-1082}
...
### REQ-1083 · Admin Configuration {#REQ-1083}
...
### REQ-1084 · Admin Configuration {#REQ-1084}
...
### REQ-1085 · Admin Navigation {#REQ-1085}
...
### REQ-1093 · Unique Constraints {#REQ-1093}
...
### REQ-1094 · PostgreSQL Catalog Compatibility {#REQ-1094}
...
### REQ-1095 · PostgreSQL Catalog Compatibility {#REQ-1095}
...
### REQ-1098 · Native Tier Database {#REQ-1098}
...
### REQ-1099 · Native Tier Database {#REQ-1099}
...
### REQ-1100 · Desktop Installation {#REQ-1100}
...
### REQ-1101 · Desktop MCP Configuration {#REQ-1101}
...
### REQ-1102 · MCP Status Endpoint {#REQ-1102}
...
### REQ-1103 · Explore MCP UI Panel {#REQ-1103}
...
### REQ-1104 · Claude Desktop Bridge {#REQ-1104}
...
### REQ-1105 · MCP Authentication {#REQ-1105}
...
### REQ-1106 · MCP Transport {#REQ-1106}
...
### REQ-1120 · Served Protocol Surface {#REQ-1120}
...
### REQ-1121 · Query Pushdown & Optimization {#REQ-1121}
...
### REQ-1122 · Access Control & Projection {#REQ-1122}
...
### REQ-1123 · Transaction Management {#REQ-1123}
...
### REQ-1124 · Mutation Enforcement {#REQ-1124}
...
### REQ-1125 · Protocol Compliance {#REQ-1125}
...
### REQ-1127 · UI Packaging {#REQ-1127}

**Status:** ✅ complete · **Priority:** MUST · **Type:** structural

React UI is precompiled into the wheel. CI runs `vite build` (from provisa-ui/package.json), embeds the output into the package tree (e.g. provisa/_ui/), and declares it in [tool.setuptools.package-data] so `python -m build` includes it. ui_server.py serves from the packaged directory path rather than __file__.parent.parent/static, eliminating the need for npm/Node at runtime or post-install. The runtime config/ files are staged into provisa/_config/ the same way so the wheel is fully self-contained.
...
### REQ-1128 · Console Entry Point {#REQ-1128}
...
### REQ-1130 · Mirror Preparation {#REQ-1130}
...
### REQ-1131 · Column Visibility Control {#REQ-1131}
...
### REQ-1132 · Semantic-Layer Meta Visibility {#REQ-1132}
...
### REQ-1133 · Domain Access Control {#REQ-1133}
...
### REQ-1134 · Governance Column Visibility {#REQ-1134}
...
### REQ-1142 · Embedded Tier Deployment {#REQ-1142}
...
### REQ-1144 · Windows Native Launcher {#REQ-1144}
...
### REQ-1145 · Windows Native Launcher {#REQ-1145}
...
### REQ-1146 · Windows Native Launcher {#REQ-1146}
...
### REQ-1147 · Windows Native Launcher {#REQ-1147}
...
### REQ-1157 · Materialized Views & Caching {#REQ-1157}

**Status:** 💡 proposed · **Priority:** SHOULD · **Type:** behavioral

A registered relation backed by `view_sql` (a Provisa-managed view or, with materialize=true, a materialized view -- [REQ-885](#REQ-885)/[REQ-543](#REQ-543), provisa/core/models.py:496-498) is DERIVED, not a base table, and MUST be exposed query-only: the schema generator MUST NOT emit insert/upsert/update/delete GraphQL mutations for it, and raw-SQL surfaces (pgwire / Flight SQL / Bolt) MUST reject writes to it. Rationale: a write to a view either fails at the source (non-updatable view) or lands in the mv_cache snapshot that the next [REQ-879](#REQ-879) refresh silently overwrites -- data loss with no error, violating the project's no-silent-failure rule. Implementation: fetch_tables carries `view_sql` (provisa/api/admin/db_queries.py:114), _build_visible_tables sets _TableInfo.read_only = bool(view_sql) (provisa/compiler/schema_types.py, provisa/compiler/schema_gen.py:_build_visible_tables), and the mutation-field loop skips read_only relations (provisa/compiler/schema_gen.py). The GraphQL read surface (query fields, aggregates, relationships) is UNCHANGED -- only the write surface is withdrawn. A base table is never affected (view_sql is null).

**Use case:** A steward composes an MV over a Provisa-hosted function ([REQ-885](#REQ-885)) and it appears in GraphQL for querying, but insert/update/delete mutations are no longer generated for it -- so a client cannot issue a write that would be lost on the next refresh. The relation reads like any table; it just cannot be written.

**Code:** `provisa/api/admin/db_queries.py`, `provisa/compiler/schema_types.py`, `provisa/compiler/schema_gen.py`
...
**Code:** `provisa/pgwire/_pipeline.py`, `provisa/pgwire/function_call.py`, `provisa/executor/function_dispatch.py`, `provisa/api/data/action_exec.py`, `provisa/processors/contract.py`, `provisa/core/models.py`, `provisa-ui/src/pages/commands/CommandFormFields.tsx`, `provisa-ui/src/api/actions.ts`
...
From a SINGLE SQL statement — including one or more inline-composed commands ([REQ-1159](#REQ-1159)) — the platform MUST be able to produce a complete column-level lineage DAG for the entire view, from source inputs to final output columns, with command nodes as first-class, contract-validated (non-opaque) nodes in the graph. Computable STATICALLY from the view definition plus each command's declared input/output dataset contract (no execution required); optionally reconciled with runtime refresh-version records ([REQ-862](#REQ-862) spans / input versions) to stamp which version flowed. Requires extending the lineage resolver from the current leaf-collapsed output-column -> source-column list (provisa/lineage/columns.py resolve_column_lineage returns flat ColumnDerivation leaves, discarding intermediate nodes) to a full node+edge graph that preserves intermediate relations (CTEs, subqueries, joins). Each inline command, once localized into a typed CTE/Arrow relation, contributes real edges: taint-closure by default (each declared output column derives from ALL declared input columns) or precise per-column edges when declared; command nodes are visually distinct opaque-transform boundaries tagged with the command name and its contract. Two grains from one graph: relation-level zoom-out and column-level drill-in. New surfaces (none exist today — column lineage is currently only OTel span attributes emitted at MV refresh): an API that takes a view/statement and returns graph JSON (nodes + edges), and a UI DAG visualization. Each transform (edge) MUST be NAMED and/or DEFINED, not left as an opaque SQL-expression string: the resolver decomposes each projection expression and matches every operation against the union vocabulary of SQL operators/standard functions (SQLGlot expression nodes), engine built-in scalar functions, and registered commands (projected into pg_proc/routines, each carrying its declared contract) — so e.g. lat,lng <- city, state is labeled as the chain "concat/+ (SQL op) -> geocode (command, contract as its def)". This is a sub-DAG inside the edge: the column-level graph states the derivation, and zooming into an edge reveals the named operation chain (expression-level command nodes reuse the same contract / taint-closure machinery). A transform matching no known op is itself a signal worth flagging.
...
**Code:** `provisa/lineage/`, `provisa/api/`, `provisa-ui/src/`

**Tests:** —

## 4. Source Connectors

### REQ-1162 · Materialization Store {#REQ-1162}
...
### REQ-1164 · Materialization Store {#REQ-1164}
