...
- **La protezione delle relazioni non può essere aggirata.** `ignore_relationships` e `relationship_guard: false` vengono entrambi ignorati; vedi [Governance delle relazioni](#governance-delle-relazioni-v002).
