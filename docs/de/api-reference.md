...
Die vollständige Schemareferenz — jedes Query-Feld, Mutation-Feld und jeder Input-/Output-Typ — finden Sie in der [Admin-GraphQL-API-Referenz](admin-graphql.md).
