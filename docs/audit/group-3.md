...
| 119 | JSONB promotion | Incomplete | DDL gen + dot-path extraction implemented + unit-tested, but `generate_promotion_ddl` never called; loader passes no `promotions_map` (`api_source/loader.py:123`) |
