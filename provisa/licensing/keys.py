...
# provisa.dev license issuer public key (REQ-1793: minted via scripts/generate_license_keypair.py;
# the matching private key lives only in the issuer's own storage and the provisa.dev Cloudflare
# Pages secret LICENSE_PRIVATE_KEY_PKCS8_B64 — never in this repo). Overridable in a
# deployment/test via PROVISA_LICENSE_PUBKEY. 32-byte Ed25519 public key, hex-encoded.
_DEFAULT_LICENSE_PUBKEY_HEX = "5b0c4a89895a5f5b7b590e500150899f2f996f2a54dd6dc41f1f52464eff981c"
