...
COLUMN_DESCRIPTIONS: dict[str, dict[str, str]] = {
    ...
    "traces": {
        ...
        "timestamp": "Span start, nanoseconds since the Unix epoch",
        "end_timestamp": "Span end, nanoseconds since the Unix epoch",
    ...
    "metrics": {
        "timestamp": "Point timestamp, nanoseconds since the Unix epoch",
    ...
    "logs": {
        "timestamp": "When the record was produced, nanoseconds since the Unix epoch",
        "observed_timestamp": "When the collector received it, nanoseconds since the Unix epoch",
    ...
    "queries": {
        ...
        "span_name": "What the span measures, e.g. provisa.query.trino",
        "service_name": "Service that emitted the span (provisa, trino, …)",
        "timestamp": "Statement start, nanoseconds since the Unix epoch",
        "end_timestamp": "Statement end, nanoseconds since the Unix epoch",
        "duration": "Elapsed nanoseconds",
        "status_code": "OpenTelemetry status — 0 unset, 1 ok, 2 error",
