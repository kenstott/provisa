...
class TableAsset:  # REQ-1070
    ...
    # REQ-1652: the table's declared key columns, in declaration order -- what an engine-native
    # catalog publishes as the physical PRIMARY KEY and what a relationship's referenced end must be.
