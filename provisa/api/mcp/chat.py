...
_SYSTEM = (
    ...
    "connection details and a reason. If exactly one candidate was found, present_choice "
    "(mode='yes_no') asking to confirm that one before proposing it. Never call propose_source or "
