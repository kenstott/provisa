...
# Canary: 886f2e35-880f-4b91-af08-329d167985dd
#
...
from provisa.auth import approval_pb2 as approval__pb2
...
def add_ApprovalServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'provisa.auth.ApprovalService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('provisa.auth.ApprovalService', rpc_method_handlers)
