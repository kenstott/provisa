...
# Canary: 5e0af6df-d7ab-44d3-9744-380a5faa17cd
#
...
"""Correlated-subquery / JSON-object rewrites for Trino transpilation (REQ-066, REQ-068).

The rewrite machinery invoked by transpile.transpile_to_trino: correlated-subquery
to CTE/LATERAL lifting and JSON-object flattening. Extracted from transpile.py.
"""
