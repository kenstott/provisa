...
# Canary: 3a7e5c91-4d68-4b2f-8e0a-9c1d6b3f704a
#
...
"""hive_s3 source adapter entry point for the Register-Table discovery flow (REQ-1730/REQ-252).
...
def discover_schema(columns: list[dict]) -> list[dict]:  # REQ-252
    """Pass through the columns `provisa.hive.fetch.table_columns` already resolved live."""
    return columns
