...
export interface RegisteredTable {
  ...
  pushDebounceQuiet: number; // REQ-1733: kafka/websocket CDC landing debounce
  pushDebounceMaxDelay: number; // REQ-1733: staleness cap under continuous message churn
