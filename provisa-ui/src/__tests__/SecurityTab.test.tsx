...
describe("SecurityTab", () => {
  ...
  it("renders the loaded mode", async () => {
    ...
    await waitFor(() => expect(screen.getByTestId("security-mode-select")).toHaveValue("Standard"));
  ...
  it("shows the warning when high is the loaded mode", async () => {
    ...
    await waitFor(() => expect(screen.getByTestId("security-high-warning")).toBeInTheDocument());
  });
