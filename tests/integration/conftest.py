...
_INTEGRATION_GROUP_PATTERNS: list[tuple[str, re.Pattern]] = [
    ...
    (
        ...
        re.compile(
            ...
            r"|sparql_exec|sparql_config_persist|neo4j_exec|neo4j_config_persist|pg_schema_upgrade|neo4j_register_table|elasticsearch_native_fetch|redis_native_fetch|cassandra_native_fetch|prometheus_native_fetch|rest_endpoints|sse_subscriptions"
