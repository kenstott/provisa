...
async def _compile(
    client: AsyncClient, query: str, role: str = "org_admin", variables: dict | None = None
):
...
async def _compile_cypher(client, query: str, flat_cypher: bool, role: str = "org_admin"):
    resp = await client.post(
        "/admin/graphql",
        json={
