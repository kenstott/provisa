...
# Canary: f394f5ad-d16f-4261-ac73-27f95dd04d47
#
...
"""E2E: MariaDB as a named source read through the direct SourcePool (REQ-1097).

MariaDB is MySQL wire-compatible, so it reuses the aiomysql direct driver. The
harness auto-provisions the mariadb container (requires_mariadb marker →
...
pytestmark = [pytest.mark.integration, pytest.mark.requires_mariadb, pytest.mark.asyncio]
...
async def test_mariadb_source_reads_through_pool(pool):
