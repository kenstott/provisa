...
def when_compiler_processes(shared_data: dict) -> None:
    ...
    try:
        coerced = _coerce_variable_values(shared_data["operation"], shared_data["variables"])
...
# Copyright (c) 2026 Kenneth Stott
# Canary: 5a78cc52-250b-4268-aec9-cba1b555944f
#
# This source code is licensed under the Business Source License 1.1
...
# Copyright (c) 2026 Kenneth Stott
# Canary: dcace306-ad66-429b-9545-06d31f899575
#
# This source code is licensed under the Business Source License 1.1
...
# Copyright (c) 2026 Kenneth Stott
# Canary: 9c76dfae-de4c-4ba6-b838-175119dc7e15
#
# This source code is licensed under the Business Source License 1.1
...
GraphQL operations may declare variable default values (e.g. ``query Q($limit: Int = 10)``).
The compiler MUST apply those defaults for any variable not present in the request
``variables`` dict, per GraphQL spec section 6.4.1. A missing declared default must not
...
# ---------------------------------------------------------------------------
# Real default-application logic (mirrors compiler behaviour, GraphQL section 6.4.1)
# ---------------------------------------------------------------------------
...
def _coerce_variable_values(document_source: str, variables: dict[str, Any]) -> dict[str, Any]:
    ...
    This is the deterministic coercion required by GraphQL spec section 6.4.1: for every
    variable declared with a default value that is absent from ``variables``, the
    default is substituted as if the caller had supplied it. No exception is raised
    when a defaulted variable is omitted.
    """
...
# Copyright (c) 2026 Kenneth Stott
# Canary: bc6076cf-5062-4dc8-9f0f-76488173f0ac
#
# This source code is licensed under the Business Source License 1.1
